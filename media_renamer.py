...
Renames photos and videos based on location metadata extracted from files.
For files without location data, uses heuristic to find closest file by modification time.
"""
...
class MediaRenamer:
    def __init__(self, dry_run: bool = False):
        ...
        self.geocoder = Nominatim(user_agent="media_renamer_tool")
...
def main():
    parser = argparse.ArgumentParser(
        description="Rename media files based on location metadata",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python media_renamer.py /path/to/photos/*.jpg
  python media_renamer.py --dry-run /Volumes/Dzianis-2/LifeHistory/2025/*
  python media_renamer.py photo1.jpg video1.mp4 photo2.heic
        """
    )
